<main>
	<form method="post" action="<?= BASEURL ?>/login/proccess">
		...
		<div title="Masukkan username anda">
			<img src="<?= BASEURL ?>/assets/img/icon/circle-user.png"><input type="text" placeholder="Username" name="username" autofocus>
		</div>
		<div title="Masukkan password anda">
			<img src="<?= BASEURL ?>/assets/img/icon/circle-padlock.png"><input type="password" placeholder="Password" name="password">
		</div>
