<main>
	...
	<form method="post" action="<?= BASEURL ?>/formulir-pengaduan/upload" enctype="multipart/form-data" title="<?= (!isset($_SESSION['masyarakatNIK'])) ? 'Silahkan login terlebih dahulu untuk melapor!' : '' ?>">
